...
var Persons = /** @class */ (function () {
    function Persons(firstname, lastname, cristinID) {
...
module.exports = "<p>\r\n  search works!\r\n</p>\r\n\r\n<div *ngFor=\"let persons of hentData\">{{persons.firstname}}</div>\r\n"
...
var core_1 = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var http_1 = __webpack_require__("./node_modules/@angular/common/esm5/http.js");
var Persons_1 = __webpack_require__("./src/app/search/Persons.ts");
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.hentData = function () {
        var _this = this;
        this.http.get("api/UsersApi/")
            ...
            if (JsonData) {
                for (var _i = 0, JsonData_1 = JsonData; _i < JsonData_1.length; _i++) {
                    ...
                    _this.Data.push(new Personer(personer.firstname, personer.lastname, personer.role, personer.institution));
                }
                ;
            }
            ;
...
this.http.get('/api/UsersApi').subscribe(function (data) {
    _this.jsondata.push(new Persons_1.Persons(scientist.firstname, scientist.lastname, scientist.CristinID));
